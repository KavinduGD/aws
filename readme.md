...
*   **Security**: Managed access and permissions securely using **IAM** (Identity and Access Management) roles, users, and policies.
...
*   [Auto Scaling Groups](./01-compute-services/02-scaling-groups/readme.md)
*   [Elastic Container Service (ECS)](./01-compute-services/03-ECS/readme.md)
*   [AWS Lambda](./01-compute-services/04-lambda/readme.md)
*   [Elastic Beanstalk](./01-compute-services/05-bean-stalk/readme.md)
*   [Elastic Kubernetes Service (EKS)](./01-compute-services/06-EKS/readme.md)

### 02. Storage
*   [S3 (Simple Storage Service)](./02-storage/01-s3/readme.md)
*   [EBS (Elastic Block Store)](./02-storage/02-EBS/readme.md)
*   [EFS (Elastic File System)](./02-storage/03-EFS/readme.md)

### 03. Networking
#### VPC (Virtual Private Cloud)
*   [VPC Fundamentals](./03-network/01-VPC/00-vpc/readme.md)
*   [Subnets](./03-network/01-VPC/01-Subnets/readme.md)
*   [Route Tables](./03-network/01-VPC/02-route-table/readme.md)
*   [Firewalls (Security Groups & NACLs)](./03-network/01-VPC/03-firewalls/readme.md)
*   [NAT Gateways](./03-network/01-VPC/04-NAT-gateway/readme.md)
*   [VPC Private Connectivity](./03-network/01-VPC/05-VPC-private-connectivity/readme.md)

#### Load Balancing
*   [Elastic Load Balancers (ELB)](./03-network/03-ELB/readme.md)

### 04. Monitoring
*   [CloudWatch](./04-monitoring/04-cloudwatch/readme.md)

### 05. CI/CD (Continuous Integration & Deployment)
*   [CodePipeline Introduction](./05-cicd/01-codepipeline/00-intro/readme.md)
*   [CodeBuild](./05-cicd/01-codepipeline/02-codebuild/readme.md)
